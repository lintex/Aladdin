...
public class LocationActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocationResult = (TextView) findViewById(R.id.id_tv_LocationResult);
        LocationResult.setMovementMethod(ScrollingMovementMethod.getInstance());//让textview可以上下滚动
        startLocation = (Button) findViewById(R.id.id_btn_startLocation);
    ...
    protected void onStart() {
        ...
        super.onStart();
        // -----------location config ------------
        locationService = ((AladdinApplication) getApplication()).locationService;
